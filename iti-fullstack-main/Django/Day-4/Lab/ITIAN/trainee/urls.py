...
from .views import list_trainee, update_trainee, delete_trainee, create_trainee, show_details, create_trainee_form, create_trainee_crispy_form, create_trainee_modelform
...
urlpatterns = [
    ...
    path('create_trainee_modelform/', create_trainee_modelform, name='create_trainee_modelform'),
